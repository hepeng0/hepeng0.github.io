---
title: 数据库MySQL系列01之死锁原理及其解决方案研究  
...
![死锁示例图](./数据库MySQL系列01之死锁原理及其解决方案研究/img.png)
...
![事务并发insert表结构](./数据库MySQL系列01之死锁原理及其解决方案研究/img_1.png)

测试用例如下:

![事务并发insert测试用例](./数据库MySQL系列01之死锁原理及其解决方案研究/img_2.png)
...
![先update再insert表结构](./数据库MySQL系列01之死锁原理及其解决方案研究/img_3.png)

测试用例如下:

![先update再insert测试用例](./数据库MySQL系列01之死锁原理及其解决方案研究/img_4.png)
