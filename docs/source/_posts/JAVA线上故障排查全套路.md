...
![](./JAVA线上故障排查全套路/img_17.png)

或者直接通过查看/proc/pid/task的数量即为线程数量。

![](./JAVA线上故障排查全套路/img_18.png)
...
![](./JAVA线上故障排查全套路/img_30.png)

接下来我们通过wireshark打开抓到的包，可能就能看到如下图所示，红色的就表示RST包了。
![](./JAVA线上故障排查全套路/img_31.png)
