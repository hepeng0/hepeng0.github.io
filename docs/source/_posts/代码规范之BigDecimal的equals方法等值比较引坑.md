...
![](./代码规范之BigDecimal的equals方法等值比较引坑/img_1.png)
...
![](./代码规范之BigDecimal的equals方法等值比较引坑/img_2.png)
...
这个就涉及到BigDecimal的标度问题了，这个问题其实是比较复杂的，由于不是本文的重点，这里面就简单介绍一下吧。
...
* **BigDecimal(double)**  
  ...
  ![](./代码规范之BigDecimal的equals方法等值比较引坑/img_3.png) 
...
![](./代码规范之BigDecimal的equals方法等值比较引坑/img_4.png)
