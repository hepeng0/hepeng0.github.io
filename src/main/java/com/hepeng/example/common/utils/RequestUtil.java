...
public final class RequestUtil {
                ...
                if(null != net.getHardwareAddress()){
                    ...
                    for(InterfaceAddress obj : addressList){
                        ...
                        if(IP instanceof Inet4Address && !localAddress.equals(IP.getHostAddress())){
                            ...
                            log.debug("IP=[{}]的子网掩码为=[{}]", serverIP, SUBNET_MASK_MAP.get(String.valueOf(obj.getNetworkPrefixLength())));
                            break tag;
                        }
                    }
                }
     ...
     * @return 返回生成的验证码字符串
     */
    public static Map<String, String> captcha(int captchaType){
        //创建随机类实例
        ...
        try(ByteArrayOutputStream baos = new ByteArrayOutputStream()){
            ...
            return new HashMap<String, String>() {
                ...
                {
                    put(CommonConstants.IMG_CAPTCHA, sb.toString());
                    put(CommonConstants.IMG_SRC_BASE64, "data:image/png;base64," + Base64.encodeBase64String(baos.toByteArray()));
                }
            };
        } catch (IOException e) {
            throw new RuntimeException(e);
    ...
    public static HttpServletRequest getHttpServletRequest() {
        // 从当前线程的RequestAttributes中获取请求
        ServletRequestAttributes attributes = (ServletRequestAttributes) RequestContextHolder.getRequestAttributes();
        if (Objects.isNull(attributes)) {
            throw new RuntimeException("无法获取当前线程中的ServletRequestAttributes");
        }
